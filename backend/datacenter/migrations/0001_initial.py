# Generated by Django 5.0 on 2024-08-26 10:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('waiting', 'Ожидает оплаты'), ('paid', 'Оплачено'), ('canceled', 'Отменено')], default='waiting', max_length=14, verbose_name='Статус счета')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('accepted', 'Принят'), ('closed', 'Закрыт'), ('canceled', 'Отменен')], default='accepted', max_length=9, verbose_name='Статус заказа')),
